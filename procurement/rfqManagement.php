<?php
// Optional guards (works even if Procurement is standalone)
  ...
  <div class="row g-0">
    ...
    <div class="sidebar d-flex flex-column">
      ...
      <nav class="nav flex-column px-2 mb-4">
        ...
        <a class="nav-link active" href="./rfqManagement.php"><ion-icon name="mail-open-outline"></ion-icon><span>RFQs &amp; Sourcing</span></a>
        ...
        <a class="nav-link" href="<?= defined("BASE_URL") ? BASE_URL : "#" ?>/auth/logout.php" class="text-danger">
