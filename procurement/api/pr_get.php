...
if(!$header){ http_response_code(404); echo json_encode(['error'=>'not_found']); exit; }

$i = $pdo->prepare("SELECT id, descr, qty, price, line_total FROM procurement_request_items WHERE pr_id=? ORDER BY id");
$i->execute([$id]);
