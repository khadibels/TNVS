...
<head>
  ...
  <style>
    ...
    .login-card{
      ...
      padding:2rem;
      box-shadow:
        0 30px 60px rgba(92, 44, 182, .25),
        0 6px 18px rgba(92, 44, 182, .15);
    }
    .login-card h3{
      font-weight:500;
    ...
    .input-icon button{
      position:absolute; right:.6rem; top:70%; transform:translateY(-50%);
      border:0; background:transparent; color:#fff; opacity:.85;
      width:36px; height:36px; display:grid; place-items:center; border-radius:0.5rem;
    }
    .input-icon button:hover{ opacity:1; }
    .btn-login{
      width:100%;
    ...
    .btn-login:hover{ transform:translateY(-1px); box-shadow:0 10px 18px rgba(0,0,0,.12); }
    .links{
      display:flex; justify-content:space-between; align-items:center; font-size:.95rem; margin-top:.75rem;
    }
    .links a{ color:#ffe36e; text-decoration:none; font-weight:500; }
    .links a:hover{ text-decoration:underline; }
    .foot-note{
      text-align:center; margin-top:1rem; color:#d8cffc;
    }
    /* small glow on the card corners like screenshot */
    .login-card::after{
