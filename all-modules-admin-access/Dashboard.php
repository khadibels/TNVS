...
<div class="container-fluid p-0">
  <div class="row g-0">
    ...
    <div class="sidebar d-flex flex-column">
      ...
      <a class="nav-link active" href="Dashboard.php"><ion-icon name="home-outline"></ion-icon><span>Dashboard</span></a>
</nav>
      ...
      <nav class="nav flex-column px-2 mb-4">
        <a class="nav-link" href="../warehousing/inventory/inventoryTracking.php"><ion-icon name="cube-outline"></ion-icon><span>Track Inventory</span></a>
        <a class="nav-link" href="../warehousing/stockmanagement/stockLevelManagement.php"><ion-icon name="layers-outline"></ion-icon><span>Stock Management</span></a>
        <a class="nav-link" href="../warehousing/TrackShipment/shipmentTracking.php"><ion-icon name="paper-plane-outline"></ion-icon><span>Track Shipments</span></a>
      </nav>

      <!-- Procurement -->
      <h6 class="text-uppercase mb-2">Procurement and Sourcing Management</h6>
      <nav class="nav flex-column px-2 mb-4">
        <a class="nav-link" href="../procurement/supplierManagement.php"><ion-icon name="person-outline"></ion-icon><span>Supplier Management</span></a>
        <a class="nav-link" href="../procurement/rfqManagement.php"><ion-icon name="mail-open-outline"></ion-icon><span>RFQs & Sourcing</span></a>
        <a class="nav-link" href="../procurement/purchaseOrders.php"><ion-icon name="document-text-outline"></ion-icon><span>Purchase Orders</span></a>
        <a class="nav-link" href="../procurement/procurementRequests.php"><ion-icon name="clipboard-outline"></ion-icon><span>Procurement Requests</span></a>
      </nav>
      ...
      <nav class="nav flex-column px-2 mb-4">
        <a class="nav-link" href="../procurement/budgetReports.php"><ion-icon name="analytics-outline"></ion-icon><span>Budgets</span></a>
        <a class="nav-link" href="../reports/globalReports.php"><ion-icon name="bar-chart-outline"></ion-icon><span>Reports</span></a>
